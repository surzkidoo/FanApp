...
if(isset($_POST["save"])){
    ...
    $article=$connect->query($sql)->fetch_assoc();
    unlink($article["post_img"]);
...
$imagetype=strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
   ...
   $profilepic=$target_file;
    ...
    $sql="update post set post_country_id=$ccountry,post_title='$header',post_img='$profilepic',post_type=$gigtype,post_content='$desc' where post_id=$post_id";
...
<div class="white fcontainer">
    <div class="container">
        <?php 
        $sql="select * from post Where post_id=$articleid";
        $article=$connect->query($sql)->fetch_assoc();
        ...
        <form method="post" action="<?php echo $_SERVER["PHP_SELF"];?>" enctype="multipart/form-data">
             <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="post_title" value="<?php echo $article["post_title"];?>" id="headline" class=" form-control"  required/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="country" id="country"  class=" form-control" required>
                        ...
                        while($country=$resultc->fetch_assoc()){
                        ?>
                         <?php if($country["id"]===$article["post_country_id"]){ ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="desc" id="txtEditor" required><?php echo $article["post_content"]; ?></textarea>
                </div>
