...
$offset=$limit*$page;
    ...
    $sql="SELECT * from post where user_id=$user order by created_on desc limit $offset,$limit";
                ...
                <div class="col-12 col-sm-12 col-md-12 mx-auto">
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-hover">
                            <th>Post Image</th><th>Post title</th><th>Edit</th><th>Delete</th>
                            <?php   
...
for($i=1;$i<=$rows;$i++){
    ...
    echo"<a id='active' href='article-dashboard.php?page=$newi'>$i</a>";
    else
    echo"<a id='' href='article-dashboard.php?page=$newi'>$i</a>";
}
