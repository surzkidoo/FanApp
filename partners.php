...
<body>
<nav><h4 class="font-weight-bolder ml-2 mt-2"><span class="text-danger">Orb</span>vibes</h4>

</nav>
<div class="container">
    <div class="advert-sec">
        <img src="11.jpg" class="" width="100%" height="150px" alt="">
    </div>
    <div class="article mt-3  p-4 mb-5">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat atque vitae corporis natus illum nisi, id numquam deserunt
         expedita fuga, voluptate cupiditate delectus? Inventore eligendi iste suscipit! Neque, est animi?
    </div>
</div>
...
<div class="container ">
    <div class="row">
        ...
        <div class="footer-contact col-12 col-sm-12 col-md-6 mb-3 col-lg-3">
            ...
            <li><a href="how-to-advertise-with-us.php">How to Advetise with us</a></li>
        </div>
        <div class="footer-contact col-12 col-sm-12 col-md-6  mb-3 col-lg-3">
