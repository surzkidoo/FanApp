...
<div class="container  mb-5">
    ...
    $limit=5;
	$limit=$limit*$id;
	$sql="SELECT * from post left join user on post.user_id = user.id where post_type=2 order  by post.created_on limit $limit";
    ...
    if($result->num_rows>=$count){
		...
		<p class="float-right"><a href="reviews.php?id=<?php echo $id++;?>" class="btn btn-outline-danger">More Reviews</a></p>
   <?php }?>
		<br>
		<br>
		<hr>
