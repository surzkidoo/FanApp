...
$sql="SELECT * from post left join user on post.Post_id = user.id  limit 5";
$magazines="empty";
if(isset($_POST["search"])){
$magazines=$_POST["magazine"];
$countrys=$_POST["country"];

	$sql="SELECT * from post left join user on post.Post_id = user.id where post_type=$magazines and post.post_country_id=$countrys limit 5";
...
<div class="white fcontainer">
    ...
    <p class="label">Magazine</p>
		...
		<hr>
		<div class="white fcontainer">
		<?php if($magazines==1 || !isset($_POST["search"])) { 

			$sql="SELECT * from post left join user on post.Post_id = user.id where post_type=1 limit 5";

if(isset($_POST["search"])){

	$sql="SELECT * from post left join user on post.user_id = user.id where post_type=$magazines and post_country_id=$countrys limit 5";
...
<div class="container  mb-5">
	...
	if($result->num_rows==0){
		echo "<h5 class='mx-auto col-6'>Post not Available in this category </h5>".$connect->error;
	...
	?>
		...
		<p class="float-right"><a href="news.php?id=1" class="btn btn-outline-danger">More News</a></p>
	...
	<?php if($magazines==2 || !isset($_POST["search"])) {
		
		
		$sql="SELECT * from post left join user on post.Post_id = user.id where post_type=2 limit 5";
...
<div class="container  mb-5">
	...
	?>
		...
		<p class="float-right"><a href="reviews.php?id=1" class="btn btn-outline-danger">More Reviews</a></p>
	...
	<?php if($magazines==3 || !isset($_POST["search"])){
	
	
	$sql="SELECT * from post left join user on post.Post_id = user.id where post_type=3 limit 5";
...
<div class="container  mb-5">
	...
	?>
		...
		<p class="float-right"><a href="reviews.php?id=1" class="btn btn-outline-danger">More Features</a></p>
