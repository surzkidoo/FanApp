...
<?php if($_SESSION["status"]=="success"){?>
 <p class="alert-success p-4">Your Payment is Sucessfuly  <a href="artist.php">Back to Profile</a></p>
<?php }?>
<?php if($_SESSION["status"]=="failed"){?>
 <p class="alert-danger p-4">Payment Failed <a href="artist.php">Back to Profile</a></p>
<?php }?>
</div>
</div>