...
<div class="container  mb-5">
    ...
    $limit=5;
	$limit=$limit*$id;
	$sql="SELECT * from post left join user on post.user_id = user.id  where post_type=6 order  by post.created_on desc  limit $limit";
...
<?php
    ...
    if($result->num_rows>=$count){
		...
		<p class="float-right"><a href="lesson.php?id=<?php echo $id++;?>" class="btn btn-outline-danger">More Lesson</a></p>
   <?php }?>
		<br>
		<br>
		<hr>
