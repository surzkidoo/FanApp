...
<nav class="navbar navbar-default navbar-expand-lg  navbar-light">
    ...
    <div class="white fcontainer">
        ...
        <a href="email.php" class="btn btn-primary px-4 d-inline-block mb-2 d-md-block active">Email</a>
                ...
                <?php if(!empty($message)){
                 ...
                 ?>
                    <div class="form-group ">
                        ...
                        <input type="text" name="email" value="<?php if(isset($con["email"])){echo$con["email"];}?>" class="form-control col-md-8 col-12" id="mobile">
                    </div>
